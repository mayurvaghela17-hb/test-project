...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: 3RWL9edbnj4/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: vDdtIXgZ2oF/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: mhJZ9T9CnOr/icon
...
function PlasmicPageLayout__RenderFunc(props) {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__cOdYh)}
          role={"img"}
        />
      }
      navMenuItems={[
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx =>
              true ? (
                <div className={classNames(projectcss.all, sty.freeBox__krVnw)}>
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__xxgFa)}
                    role={"img"}
                  />
                </div>
              ) : null
      ...
      >
        <ph.DataCtxReader>
          {$ctx =>
            true ? (
              <div className={classNames(projectcss.all, sty.freeBox___41Glr)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <section
                      className={classNames(projectcss.all, sty.section__jw7Tu)}
                    >
                      <h1
                        className={classNames(
                          projectcss.all,
